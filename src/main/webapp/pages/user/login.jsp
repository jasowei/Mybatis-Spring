    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form>
                ...
                <button type="button" class="btn btn-primary" id="b">登录</button>
                <a href="/pages/blog/blogpage.jsp">go</a>
...
//                    location.href = "/blogpage/" + result.data.id
    ...
    $("#r").click(function () {
        location.href = "/pages/user/register.jsp"
    })
